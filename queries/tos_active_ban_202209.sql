...
--all active TOS BANs in the month of Sep 2022
CREATE OR REPLACE TABLE `divg-josh-pr-d1cc3a.tos_crosssell.tos_active_ban_202209`
AS
...
select * from `divg-josh-pr-d1cc3a.tos_crosssell.tos_active_ban_202209`
