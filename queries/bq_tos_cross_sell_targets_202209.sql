...
DECLARE target_month_start DATE DEFAULT "2022-09-01";
DECLARE target_month_end DATE DEFAULT "2022-09-30"; 

--all BANs that added TOS to the service in 202209
CREATE OR REPLACE TABLE `divg-josh-pr-d1cc3a.tos_crosssell.tos_cross_sell_targets_202209`
AS
--25095
...
CREATE OR REPLACE TABLE `divg-josh-pr-d1cc3a.tos_crosssell.norton_cross_sell_targets_202209` 
...
CREATE OR REPLACE TABLE `divg-josh-pr-d1cc3a.tos_crosssell.bq_tos_cross_sell_targets_202209`
...
(
  ...
  from 
  (
  (select distinct ban from `divg-josh-pr-d1cc3a.tos_crosssell.norton_cross_sell_targets_202209`) 
  union all 
  (select distinct ban from `divg-josh-pr-d1cc3a.tos_crosssell.tos_cross_sell_targets_202209`)
  )
  group by ban
) b 
on a.ffh_ban = b.ban 
...
--  FROM `divg-josh-pr-d1cc3a.tos_crosssell.bq_tos_cross_sell_targets_202209`
