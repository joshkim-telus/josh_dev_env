...
select distinct bacct_bus_bacct_num
...
and date(a.prod_instnc_ts) = date_sub(dt1.max_date, INTERVAL 1 DAY) 
and date(a.pi_cntrct_end_ts) between score_date and score_date_this_month_dash 
