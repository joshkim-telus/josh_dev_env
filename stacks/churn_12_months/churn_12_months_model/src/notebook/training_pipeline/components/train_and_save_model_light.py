...
#     # save HTML report 
#     todays_date = datetime.now().strftime("%Y-%m-%d")
#     save_path = f'churn_12_months/reports/'
#     create_folder_if_not_exists(save_path)
#     final_model_report.write_html(f"{save_path}{model_class_name}_{todays_date}.html")
#     filename = f"{model_class_name}_{todays_date}.html"
#     blob = bucket.blob(f"{save_path}{filename}")
#     blob.upload_from_filename(f"{save_path}{todays_date}_{model_class_name}.html")
#     print(f"{filename} sucessfully uploaded to GCS bucket!")
