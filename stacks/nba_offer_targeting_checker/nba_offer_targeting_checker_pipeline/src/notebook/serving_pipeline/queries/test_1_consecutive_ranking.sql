...
valid_t1 AS (
  SELECT *,
  'valid_t1' as table_1 FROM bi-stg-mobilityds-pr-db8ce2.nba_offer_targeting_np.nba_ffh_offer_ranking_cat3
),
valid_t2 AS (
  SELECT *,
  'valid_t2' as table_2 FROM bi-stg-mobilityds-pr-db8ce2.nba_offer_targeting_np.nba_ffh_offer_ranking_existing
),
valid_t3 AS (
  SELECT *,
  'valid_t3' as table_3 FROM bi-stg-mobilityds-pr-db8ce2.nba_offer_targeting_np.nba_ffh_offer_ranking_prospects
)
SELECT 
  OO.cust_id,
  OO.mobility_ban,
