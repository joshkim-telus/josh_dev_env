...
SELECT base.ref_dt,
  ...
  LEFT JOIN `bi-srv-features-pr-ef5a93.ban_clckstrm.bq_ban_clckstrm_telus` AS clk
   ...
   AND clk.part_dt BETWEEN DATE_SUB(base.ref_dt, INTERVAL 30 DAY) AND DATE_SUB(base.ref_dt, INTERVAL 1 DAY)
   AND clk.part_dt BETWEEN DATE_SUB(_from_dt, INTERVAL 30 DAY) AND DATE_SUB(_to_dt, INTERVAL 1 DAY)
  GROUP BY 1, 2
