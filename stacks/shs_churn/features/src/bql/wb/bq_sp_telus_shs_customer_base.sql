...
BEGIN 
    ...
    -- CREATE OR REPLACE TABLE `divg-groovyhoon-pr-d2eab4.shs_churn_model.bq_telus_shs_customer_base` AS 

    TRUNCATE TABLE `divg-groovyhoon-pr-d2eab4.shs_churn_model.bq_telus_shs_customer_base`; 
    INSERT INTO `divg-groovyhoon-pr-d2eab4.shs_churn_model.bq_telus_shs_customer_base`

    WITH base AS (
    SELECT 
        PARSE_DATE('%d-%b-%y', shs_mthly_product_snapshot.mthly_prod_instnc_snpsht_ts) AS mthly_prod_instnc_snpsht_ts, 
        shs_mthly_product_snapshot.LINE_OF_BUSINESS_CD AS line_of_business_cd, 
        shs_mthly_product_snapshot.activation_ts AS activation_ts,
        ...
        shs_mthly_product_snapshot.contract_start_dt AS contract_start_dt,
        shs_mthly_product_snapshot.contract_end_dt AS contract_end_dt,
        ...
        cast(shs_mthly_product_snapshot.unit_count_ind AS INT64) AS unit_count_ind,
    ...
    WHERE 
    cust_type_cd = 'R' 
    AND cast(unit_count_ind AS INT64) = 1 
    AND cast(shs_mthly_product_snapshot.master_src_id AS INT64) <> 130 
