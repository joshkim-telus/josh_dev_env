...
@component(
    ...
    output_component_file="nba_ffh_offer_ranking_prospects.yaml",
)
def nba_ffh_offer_ranking_prospects(project_id: str
                      , dataset_id: str
                      , token: str
                      ):
...
#     job_config = bigquery.QueryJobConfig()
    ...
    query =\
        f'''        
            ...
            WHERE table_name='nba_ffh_offer_ranking_prospects'
        '''
