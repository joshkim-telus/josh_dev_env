...
#     job_config = bigquery.QueryJobConfig()
    ...
    sq0l =f"""
        ...
        where part_load_dt = '2024-03-26'
            and effective_end_dt >= CURRENT_DATE()
            and (
            upper(prod_intrnl_nm) like '%TSD%'
        ...
        select distinct cust_id 
         ...
         inner join `divg-team-v03-pr-de558a.nba_offer_targeting.prod_cd_exclusions` b
         on a.prod_cd = b.prod_cd
        where a.part_load_dt = '2024-03-26'
        ...
        left join `divg-team-v03-pr-de558a.nba_offer_targeting.bq_whsiagtm4testing` f on a.LPDS_ID = f.LPDSId
        ...
        left join `divg-team-v03-pr-de558a.OT.SHS_FSA_List_native` h on substr(a.SERV_POSTAL_CODE, 1, 3) = h.FSA
