CREATE OR REPLACE PROCEDURE shs_churn.sp_persist_master_features_set(_from_dt DATE, _to_dt DATE)
...
*/
  ...
  SELECT * FROM `divg-groovyhoon-pr-d2eab4.shs_churn.cust_ban_tf`(_from_dt, _to_dt);
  
  CREATE OR REPLACE TEMPORARY TABLE prod_mix AS 
  SELECT * FROM `divg-groovyhoon-pr-d2eab4.shs_churn.prod_mix_cust_tf`(_from_dt, _to_dt);

  CREATE OR REPLACE TEMPORARY TABLE bill_wln AS 
  SELECT * FROM `divg-groovyhoon-pr-d2eab4.shs_churn.bill_wln_cust_tf`(_from_dt, _to_dt);

  CREATE OR REPLACE TEMPORARY TABLE tenure AS 
  SELECT * FROM `divg-groovyhoon-pr-d2eab4.shs_churn.tenure_cust_ban_tf`(_from_dt, _to_dt);

  CREATE OR REPLACE TEMPORARY TABLE demogr AS 
  SELECT * FROM `divg-groovyhoon-pr-d2eab4.shs_churn.demogr_cust_tf`(_from_dt, _to_dt);

  CREATE OR REPLACE TEMPORARY TABLE clickstream AS 
  SELECT * FROM `divg-groovyhoon-pr-d2eab4.shs_churn.clickstream_cust_tf`(_from_dt, _to_dt);

  CREATE OR REPLACE TEMPORARY TABLE app_usg AS 
  SELECT * FROM `divg-groovyhoon-pr-d2eab4.shs_churn.app_usg_cust_tf`(_from_dt, _to_dt);

  CREATE OR REPLACE TEMPORARY TABLE call_centre AS 
  SELECT * FROM `divg-groovyhoon-pr-d2eab4.shs_churn.call_centre_cust_tf`(_from_dt, _to_dt);

  CREATE OR REPLACE TEMPORARY TABLE hs_usage AS 
  SELECT * FROM `divg-groovyhoon-pr-d2eab4.shs_churn.hs_usage_cust_tf`(_from_dt, _to_dt);

  CREATE OR REPLACE TEMPORARY TABLE shs_features AS 
  SELECT * FROM `divg-groovyhoon-pr-d2eab4.shs_churn.shs_features_cust_tf`(_from_dt, _to_dt);
  ...
  SELECT base.*,
    ...
    FROM `divg-groovyhoon-pr-d2eab4.shs_churn.master_target_table` AS base
    LEFT JOIN cust_ban
  ...
  -- DELETE FROM `divg-groovyhoon-pr-d2eab4.shs_churn.master_features_set`
  ...
  -- INSERT INTO `divg-groovyhoon-pr-d2eab4.shs_churn.master_features_set`
  -- (
  --   from_dt,
  --   to_dt,
  --   training_mode,
  ...
  CREATE OR REPLACE TABLE shs_churn.master_features_set AS 
...
CALL shs_churn.sp_persist_master_features_set("2023-01-01", "2023-12-31")
